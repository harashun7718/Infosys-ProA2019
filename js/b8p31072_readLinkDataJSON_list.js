$(function(){
	$("main").ready(function(){
		...
		var url = "http://linkdata.org/api/1/rdf1s8306i/gunnma_corona_hospital_rdf.json?callback=?";//←各チームの企画によって変更！
		var resource_uri = "http://linkdata.org/resource/1/rdf1s8306i"; //データIDにあたるURLの部分をここに書く
